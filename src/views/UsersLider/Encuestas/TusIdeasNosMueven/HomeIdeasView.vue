<script setup>
    ...
    import IdeaFilter from '@/components/lider/encuesta-ideas/IdeaFilter.vue';
    import IdeasHeader from '@/components/lider/encuesta-ideas/IdeasHeader.vue';
    import IdeasTable from '@/components/lider/encuesta-ideas/IdeasTable.vue';
    import IdeaTableMobile from '@/components/lider/encuesta-ideas/mobile/IdeaTableMobile.vue';

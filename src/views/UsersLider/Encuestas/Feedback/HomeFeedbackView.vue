<script setup>
    ...
    import FeedbackFilter from '@/components/lider/encuesta-feedback/FeedbackFilter.vue';
    import FeedbackHeader from '@/components/lider/encuesta-feedback/FeedbackHeader.vue';
    import FeedbacksTable from '@/components/lider/encuesta-feedback/FeedbacksTable.vue';
    import FeedbackTableMobile from '@/components/lider/encuesta-feedback/mobile/FeedbackTableMobile.vue';

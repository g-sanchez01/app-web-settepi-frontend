<script setup>
    ...
    import IdeaFilter from '@/components/admin/encuesta-ideas/IdeaFilter.vue';
    import IdeasHeader from '@/components/admin/encuesta-ideas/IdeasHeader.vue';
    import IdeasTable from '@/components/admin/encuesta-ideas/IdeasTable.vue';
    import IdeaTableMobile from '@/components/admin/encuesta-ideas/mobile/IdeaTableMobile.vue';

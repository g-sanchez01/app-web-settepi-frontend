            ...
            <nav class="mt-4 px-4 space-y-2">
                ...
                >
                    ...
                    >
                        ...
                        <span class="text-lg">Mi Equipo</span>
                    </div>
                
                </router-link>

                <router-link
                    to="/admin-dev/empleado-mes"
                    v-slot="{ isActive }"
                >
                    <div
                        :class="[
                    ...
                    >
                        ...
                        <span class="text-lg">Empleado del Mes</span>
                    </div>
                
                </router-link>

                <router-link
                    to="/admin-dev/usuarios"
                    v-slot="{ isActive }"
                >
                    <div
                        :class="[
